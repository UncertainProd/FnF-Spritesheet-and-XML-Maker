...
class Ui_TableWidgetThing(object):
    def setupUi(self, TableWidgetThing):
        ...
        self.framewidth_spinbox.setMinimum(-10000)
        ...
        self.frameheight_spinbox.setMinimum(-10000)
